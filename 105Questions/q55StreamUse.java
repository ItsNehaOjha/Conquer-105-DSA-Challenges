...
// means digit i should be mapped to digit j in this system.The mapped value of an integer is the new integer obtained by 
// replacing each occurrence of digit i in the integer with mapping[i] for all 0 <= i <= 9.
